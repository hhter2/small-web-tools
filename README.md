...
19. **QR & Barcode Scanner**: Client-side QR code and barcode scanner using camera capture or drag-and-drop image files. Decodes 14+ 1D/2D formats, plays a beep chime on match, and displays context-aware controls (e.g. WiFi configuration cards, clickable links, mail/SMS pre-fills).
