...
- **Codon InfoPanel Layout Upgrades**: Replaced the large codon code in the header with the amino acid name (e.g. Proline) as the primary title. Placed the 3-letter and 1-letter abbreviations next to it styled as larger, premium badges. Reordered the layout to position the base bubbles (1st, 2nd, 3rd) at the top of the card, and moved the selected codon and synonymous codons section below the bubbles.
